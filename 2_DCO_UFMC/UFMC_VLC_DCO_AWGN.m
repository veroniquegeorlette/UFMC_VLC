...
subbandOffset = 4;%2;%50;%64 % numFFT/2-subbandSize*numSubbands/2 for band center
numUFMCSymbols=10;
...
%  Initialize arrays
inpData = zeros(numSubbands,subbandSize );
...
%  Loop over each subband
    ...
    %bitsInSym_1=reshape(bitsInSym_,bitsPerSubCarrier,[]);
